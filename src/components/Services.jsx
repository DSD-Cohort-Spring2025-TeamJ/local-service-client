...
export default function Services() {
    ...
    const renderServiceButtons = services.map(s => <Button 
        ...
        hover:bg-green-700 hover:text-white active:scale-90"
        key={s.service_id} onClick={handleSelectService}
        id={s.service_id}>{s.service_name} 
        </Button>)
